                ...
                <nav class="flex items-center justify-end gap-4">
                    @auth
                        <a
                            ...
                            class="inline-block px-5 py-1.5 dark:text-[#EDEDEC] border-white hover:border-[#1915014a] border text-white dark:border-[#3E3E3A] dark:hover:border-[#62605b] rounded-sm text-sm leading-normal"
                        >
                            Dashboard
                        </a>
                    @else
